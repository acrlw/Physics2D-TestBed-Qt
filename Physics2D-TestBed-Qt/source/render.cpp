...
namespace Physics2D
{
    void RendererQtImpl::renderPoint(QPainter* painter, Camera* camera, const Vector2& point, const QPen& pen)
    {
    ...
    void RendererQtImpl::renderLine(QPainter* painter, Camera* camera, const Vector2& p1, const Vector2& p2, const QPen& pen)
    {
        assert(painter != nullptr && camera != nullptr);
    ...
    void RendererQtImpl::renderPoints(QPainter* painter, Camera* camera, const std::vector<Vector2>& points,
        const QPen& pen)
    {
        assert(painter != nullptr && camera != nullptr);
        QPolygonF pts;
    ...
    void RendererQtImpl::renderLines(QPainter* painter, Camera* camera,
    ...
    void RendererQtImpl::renderPolygon(QPainter* painter, Camera* camera, const ShapePrimitive& shape, const QPen& pen)
    {
        assert(painter != nullptr && camera != nullptr);
    ...
    void RendererQtImpl::renderEdge(QPainter* painter, Camera* camera, const ShapePrimitive& shape, const QPen& pen)
    {
        assert(painter != nullptr && camera != nullptr);
    ...
    void RendererQtImpl::renderRectangle(QPainter* painter, Camera* camera, const ShapePrimitive& shape, const QPen& pen)
    {
        assert(painter != nullptr && camera != nullptr);
        assert(shape.shape->type() == Shape::Type::Polygon);
    ...
    void RendererQtImpl::renderCircle(QPainter* painter, Camera* camera, const ShapePrimitive& shape, const QPen& pen)
    {
        assert(painter != nullptr && camera != nullptr);
    ...
    void RendererQtImpl::renderCapsule(QPainter* painter, Camera* camera, const ShapePrimitive& shape, const QPen& pen)
    {
        assert(painter != nullptr && camera != nullptr);
    ...
    void RendererQtImpl::renderSector(QPainter* painter, Camera* camera, const ShapePrimitive& shape, const QPen& pen)
    {
        assert(painter != nullptr && camera != nullptr);
    ...
    void RendererQtImpl::renderEllipse(QPainter* painter, Camera* camera, const ShapePrimitive& shape, const QPen& pen)
    {
        assert(painter != nullptr && camera != nullptr);
    ...
    void RendererQtImpl::renderCurve(QPainter* painter, Camera* camera, const ShapePrimitive& shape, const QPen& pen)
    {
        assert(painter != nullptr && camera != nullptr);
    ...
    void RendererQtImpl::renderAngleLine(QPainter* painter, Camera* camera, const ShapePrimitive& shape)
    {
        assert(painter != nullptr && camera != nullptr);
    ...
    void RendererQtImpl::renderAABB(QPainter* painter, Camera* camera, const AABB& aabb, const QPen& pen)
    {
        assert(painter != nullptr && camera != nullptr);
        painter->setPen(pen);
    ...
    void RendererQtImpl::renderRotationJoint(QPainter* painter, Camera* camera, Joint* joint, const QPen& pen)
    {
        assert(joint != nullptr);
        RotationJoint* angleJoint = dynamic_cast<RotationJoint*>(joint);
    }

    void RendererQtImpl::renderDistanceJoint(QPainter* painter, Camera* camera, Joint* joint, const QPen& pen)
    {
        assert(joint != nullptr);
    ...
    void RendererQtImpl::renderPointJoint(QPainter* painter, Camera* camera, Joint* joint, const QPen& pen)
    {
        assert(joint != nullptr);
    ...
    void RendererQtImpl::renderOrientationJoint(QPainter* painter, Camera* camera, Joint* joint, const QPen& pen)
    {
        assert(joint != nullptr);
    ...
    void RendererQtImpl::renderPulleyJoint(QPainter* painter, Camera* camera, Joint* joint, const QPen& pen)
    {
        assert(joint != nullptr);

    }

    void RendererQtImpl::renderPrismaticJoint(QPainter* painter, Camera* camera, Joint* joint, const QPen& pen)
    {
        assert(joint != nullptr);

    }

    void RendererQtImpl::renderRevoluteJoint(QPainter* painter, Camera* camera, Joint* joint, const QPen& pen)
    {
        assert(joint != nullptr);
    ...
    void RendererQtImpl::renderWheelJoint(QPainter* painter, Camera* camera, Joint* joint, const QPen& pen)
    {
        assert(joint != nullptr);

    }

    void RendererQtImpl::renderJoint(QPainter* painter, Camera* camera, Joint* joint, const QPen& pen)
    {
        assert(painter != nullptr && camera != nullptr);
    ...
    void RendererQtImpl::renderShape(QPainter* painter, Camera* camera, const ShapePrimitive& shape, const QPen& pen)
    {
        assert(painter != nullptr && camera != nullptr);
